	...
	chika.on('message-new', async (amv) => {
		...
		setTimeout( () => {
			...
			switch(command) {
                ...
                if (!isRegistered) return reply( ind.noregis())
                    query = args.join(" ")
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/kusonimesearch?apikey=7f5a6556983b0bf183028c20&query=${query}`)
		...
		case 'nulis':
				...
				ct = body.slice(6)
				reply(ind.wait())
				ct = await getBuffer(`http://lolhuman.herokuapp.com/api/nulis?apikey=7f5a6556983b0bf183028c20&text=${ct}`)
		...
		case 'pupycut':
				...
				ct = body.slice(8)
				reply(ind.wait())
				ct = await getBuffer(`http://lolhuman.herokuapp.com/api/ephoto1/puppycute?apikey=7f5a6556983b0bf183028c20&text=${ct}`)
				chika.sendMessage(from, ct, image, {caption: 'Nih kak udah jadi..', quoted: amv})
				await limitAdd(sender)
				break
		case 'galaxstyle':
				...
				ct = body.slice(11)
				reply(ind.wait())
				ct = await getBuffer(`http://lolhuman.herokuapp.com/api/ephoto1/galaxystyle?apikey=7f5a6556983b0bf183028c20&text=${ct}`)
				chika.sendMessage(from, ct, image, {caption: 'Nih kak udah jadi..', quoted: amv})
				await limitAdd(sender)
				break
		case 'hologram':
				...
				ct = body.slice(9)
				reply(ind.wait())
				ct = await getBuffer(`http://lolhuman.herokuapp.com/api/ephoto1/hologram3d?apikey=7f5a6556983b0bf183028c20&text=${ct}`)
				chika.sendMessage(from, ct, image, {caption: 'Nih kak udah jadi..', quoted: amv})
				await limitAdd(sender)
				break
		case 'textbyname':
				...
				ct = body.slice(11)
				reply(ind.wait())
				ct = await getBuffer(`http://lolhuman.herokuapp.com/api/ephoto1/textbyname?apikey=7f5a6556983b0bf183028c20&text=${ct}`)
				chika.sendMessage(from, ct, image, {caption: 'Nih kak udah jadi..', quoted: amv})
				await limitAdd(sender)
				break
		case 'herrypoter':
				...
				ct = body.slice(11)
				reply(ind.wait())
				ct = await getBuffer(`http://lolhuman.herokuapp.com/api/photooxy1/harrypotter?apikey=7f5a6556983b0bf183028c20&text=${ct}`)
				chika.sendMessage(from, ct, image, {caption: 'Nih kak udah jadi..', quoted: amv})
				await limitAdd(sender)
				break
		case 'greanneon':
				...
				ct = body.slice(10)
				reply(ind.wait())
				ct = await getBuffer(`http://lolhuman.herokuapp.com/api/ephoto1/greenneon?apikey=7f5a6556983b0bf183028c20&text=${ct}`)
				chika.sendMessage(from, ct, image, {caption: 'Nih kak udah jadi..', quoted: amv})
				await limitAdd(sender)
				break
		case 'metallogo':
				...
				ct = body.slice(10)
				reply(ind.wait())
				ct = await getBuffer(`http://lolhuman.herokuapp.com/api/ephoto1/metallogo?apikey=7f5a6556983b0bf183028c20&text=${ct}`)
				chika.sendMessage(from, ct, image, {caption: 'Nih kak udah jadi..', quoted: amv})
				await limitAdd(sender)
				break
		/*case 'nulis2':
		...
		case 'cblackpink':
				...
				bh = body.slice(11)
				reply(ind.wait())
				bh = await getBuffer(`http://lolhuman.herokuapp.com/api/textprome/blackpink?apikey=7f5a6556983b0bf183028c20&text=${bh}`)
				chika.sendMessage(from, bh, image, {caption: 'Nih kak udah jadi..', quoted: amv})
				await limitAdd(sender)
				break
		case 'thunder':
		...
		case 'shota':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				reply(ind.wait())
				anu = await fetchJson(`http://lolhuman.herokuapp.com/api/random/meme?apikey=7f5a6556983b0bf183028c20`, {method: 'get'})
				buffer = await getBuffer(anu.result)
				chika.sendMessage(from, buffer, image, {quoted: amv})
				await limitAdd(sender)
				break
		...
		case 'grenneon':
				...
				aruga = body.slice(10)
				reply(ind.wait())
				aruga = await getBuffer(`http://lolhuman.herokuapp.com/api/textprome/greenneon?apikey=7f5a6556983b0bf183028c20&text=LoLHuman${aruga}`)
				chika.sendMessage(from, aruga, image, {caption: 'Nih kak', quoted: amv})
				await limitAdd(sender)
				break 
		case 'neontext':
				...
				aruga = body.slice(10)
				reply(ind.wait())
				aruga = await getBuffer(`http://lolhuman.herokuapp.com/api/textprome/neon?apikey=7f5a6556983b0bf183028c20&text=LoLHuman${aruga}`)
				chika.sendMessage(from, aruga, image, {caption: 'Nih kak', quoted: amv})
				await limitAdd(sender)
				break 
		case 'toxic13':
...
╰❑➤─| 𝙼𝙰𝙽𝙲𝙰 ⊱✿⊰ 𝙱𝙾𝚃 |─➤✿°࿐` 
        ...
        if (budy.includes(`manca`)) {
                   ...
                   let ainecss = fs.readFileSync('./mp3/WhatsApp-Ptt-2021-02-10-at-02.16.542.opus')
                   chika.sendMessage(from, ainecss, MessageType.audio, { quoted: amv, ptt: true })
